...
public:
  ...
  void faa(GlobalAddress gaddr, int64_t add_val, uint64_t *rdma_buffer, bool signal = true, CoroContext *ctx = nullptr);
  void faa_sync(GlobalAddress gaddr, int64_t add_val, uint64_t *rdma_buffer, CoroContext *ctx = nullptr);
...
// Default alignment with a granularity of 256 bytes
